...
b[2].toLowerCase()),d[c]=e,"o"===b[1]&&E(a[e]))});a._hungarianMap=d}function P(a,b,c){a._hungarianMap||E(a);var d;l.each(b,function(e,h){d=a._hungarianMap[e];d===q||!c&&b[d]!==q||("o"===d.charAt(0)?(b[d]||(b[d]={}),l.extend(!0,b[d],b[e]),P(a[d],b[d],c)):b[d]=b[e])})}function ma(a){var b=u.defaults.oLanguage,c=b.sDecimal;c&&Wa(c);if(a){var d=a.sZeroRecords;!a.sEmptyTable&&d&&"Brak danych"===b.sEmptyTable&&X(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&d&&"Loading..."===b.sLoadingRecords&&
...
sNext:"<i class=\"fas fa-arrow-right mt-1\" style='height: 20px;'></i>",sPrevious:"<i class=\"fas fa-arrow-left mt-1\" style='height: 20px;'></i>"},sEmptyTable:"Brak danych",sInfo:"Pokazuje od _START_ do _END_ z _TOTAL_ wyników",sInfoEmpty:"Brak wyników",sInfoFiltered:"(przeszukano _MAX_ pozycji)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Pokaż _MENU_ pozycji",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Wyszukaj:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Brak wyników"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
